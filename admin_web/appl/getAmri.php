...
$venue=$_POST['venue'];
$theme=$_POST['theme'];
    $response = mysqli_query($con,"SELECT * FROM summer where theme='$theme' and venue='$venue' and approval=1 and org=1 and pat=0 and closure=0 order by entry_date desc");
