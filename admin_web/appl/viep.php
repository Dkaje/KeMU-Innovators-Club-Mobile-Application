...
//$venue=$_POST['venue'];
$reg_no=$_POST['reg_no'];
    $response = mysqli_query($con,"SELECT * FROM summer where reg_no='$reg_no' and status=1 and pay=0 and closure=0 order by entry_date desc");
    if (mysqli_num_rows($response) > 0) {
        ...
        $results['trust'] = 0;
        $results['mine'] = "No Record awaitng contribution";
    }
