...
error_reporting(0);
    ...
    if (isset($_POST['approveBtn'])) {
        ...
        if (mysqli_query($con, "update official set status=1,remarks='' where stud_id = '$studid '")) {
            ...
            echo "<script>location.href='patA.php' </script>";
        } else {
...
<div class="dropdown" style="float: left;">
    <button class="btn btn-primary btn-xs" type="button"
        data-toggle="dropdown">Manage Patrons   <i class="fas fa-caret-down" style="color: #fff;"></i></button>
 <ul class="dropdown-menu alert panel-footer">
        <li>
        <a href="pat.php"class="btn btn-secondary btn-xs">Pending</a><br>
        <a href="patA.php"class="btn btn-success btn-xs">Approved</a><br>
        <a href="patR.php"class="btn btn-danger btn-xs">Rejected</a>
        </li>
    </ul></div><br>
                    <!-- Page Heading -->
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <tbody>
                                            <?php
                                                $query_run = mysqli_query($con, "SELECT * FROM official where role='Patron' and status=1");
                                                $i = 1;
