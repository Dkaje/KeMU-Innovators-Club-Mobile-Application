...
<div class="dropdown" style="float: left;">
    <button class="btn btn-primary btn-xs" type="button"
        data-toggle="dropdown">Fresh Card Applications</button>
    </ul></div><br>
                    <!-- Page Heading -->
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <tbody>
                                            <?php
                                                $query_run = mysqli_query($con, "SELECT * FROM cardy_one where deter='F'");
                                                $i = 1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php if($row['secsta']==0){echo 'Not Issued';}else{echo 'Issued';} ?></td>
