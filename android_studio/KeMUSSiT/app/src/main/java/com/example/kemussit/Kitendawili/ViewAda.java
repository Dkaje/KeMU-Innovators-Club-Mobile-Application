...
public class ViewAda extends ArrayAdapter<ViewRegistry> {
    ...
    public ViewAda(Context context, int id, ArrayList<ViewRegistry> subjectArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.txtamt.setText(subject.getStatus());
        return convertView;
    }
