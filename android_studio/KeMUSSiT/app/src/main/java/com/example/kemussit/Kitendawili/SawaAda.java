...
public class SawaAda extends ArrayAdapter<ViewRegistry> {
    ...
    public SawaAda(Context context, int id, ArrayList<ViewRegistry> subjectArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.txtamt.setText(subject.getApproval());
        return convertView;
    }
