...
public class NewPay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener((adapterView, view, i, l) -> {
            ...
            alertDialog.getButton(DialogInterface.BUTTON_POSITIVE).setOnClickListener(view1 -> {
                ...
                requestQueue.add(new StringRequest(Request.Method.POST, Connect.approval,
                        response -> {
                            try {
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        params.put("status", "1");
                        params.put("finsta", "1");
                        params.put("fresh", cardMode.getFees());
    ...
    private void getCard() {
        requestQueue = Volley.newRequestQueue(getApplicationContext());
        requestQueue.add(new StringRequest(Request.Method.POST, Connect.getPay,
                response -> {
                    try {
                        jsonObject = new JSONObject(response);
                        ...
                        if (success == 1) {
                            ...
                            cardAda = new PayAda(NewPay.this, R.layout.roller, cardModeArrayList);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.App:
                startActivity(new Intent(getApplicationContext(), AppFresh.class));
                break;
            case R.id.Rej:
                startActivity(new Intent(getApplicationContext(), RejFresh.class));
                break;
            default:
        }
