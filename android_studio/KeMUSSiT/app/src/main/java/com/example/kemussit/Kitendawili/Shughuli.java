...
public class Shughuli extends ArrayAdapter<ViewRegistry> {
    ...
    public Shughuli(Context context, int id, ArrayList<ViewRegistry> subjectArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = vi.inflate(R.layout.someone, null);
