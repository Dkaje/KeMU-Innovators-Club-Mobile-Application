...
public class ConRej extends AppCompatActivity {
    LastAda cardAda;
    LastDay cardMode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Rejected EventPay");
        setContentView(R.layout.activity_con_rej);
                ...
                response -> {
                    try {
                        ...
                        if (success == 1) {
                            ...
                            cardAda = new LastAda(ConRej.this, R.layout.roller, cardModeArrayList);
