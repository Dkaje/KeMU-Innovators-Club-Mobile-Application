...
public class SessionAda extends ArrayAdapter<CheckMode> {
    public ArrayList<CheckMode> MainList;
    public ArrayList<CheckMode> SubjectListTemp;
    public SubjectDataFilter subjectDataFilter;

    public SessionAda(Context context, int id, ArrayList<CheckMode> subjectArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CheckMode subject = SubjectListTemp.get(position);
        int pos = position + 1;
    ...
    private class SubjectDataFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            if (charSequence != null && charSequence.toString().length() > 0) {
                ArrayList<CheckMode> arrayList1 = new ArrayList<>();

                for (int i = 0, l = MainList.size(); i < l; i++) {
                    CheckMode subject = MainList.get(i);
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
            ...
            SubjectListTemp = (ArrayList<CheckMode>) filterResults.values;
