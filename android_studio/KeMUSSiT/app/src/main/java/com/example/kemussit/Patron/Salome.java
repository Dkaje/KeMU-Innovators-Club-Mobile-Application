...
public class Salome extends AppCompatActivity {
    SahauAda eventAda;
    SahauMode evenMdel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Past Club Events");
        setContentView(R.layout.activity_salome);
        ...
        listView.setOnItemClickListener((adapterView, view, i, l) -> {
            ...
            startActivity(new Intent(getApplicationContext(), Changer.class).putExtra("theme", evenMdel.getTheme()).putExtra("venue", evenMdel.getVenue()).putExtra("club", evenMdel.getClub()).putExtra("counter", evenMdel.getCounter()));
        });
    }

    private void getCard() {
        requestQueue = Volley.newRequestQueue(getApplicationContext());
        requestQueue.add(new StringRequest(Request.Method.POST, Connect.interSec,
                response -> {
                    try {
                        ...
                        if (success == 1) {
                            ...
                            eventAda = new SahauAda(Salome.this, R.layout.russia, evenMdelArrayList);
