...
public class TreHome extends AppCompatActivity {
    Model model;
    TresSess stuSess;
    RelativeLayout relativeLayout, relatived;
    CardView cardView;
    Button profi, logger;
    ...
    Button btn, baite, solubility, helper;
    OnceMode onceMode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        solubility = findViewById(R.id.btnGreat);
        relatived = findViewById(R.id.solubleSalts);
        checkRpo();
    }
    ...
    private void getMajors() {
        ...
        helper.setOnClickListener(view -> {
            ...
            help.setTitle("Help Treasurer");
            help.setMessage(getString(R.string.Tes));
        ...
        solubility.setOnClickListener(view -> {
            if (relatived.getVisibility() == View.VISIBLE) {
                relatived.setVisibility(View.GONE);
            } else {
                relatived.setVisibility(View.VISIBLE);
            }
        });
        findViewById(R.id.btnEvent).setOnClickListener(view -> {
            startActivity(new Intent(getApplicationContext(), NewPay.class));
        });
        findViewById(R.id.btnRenewal).setOnClickListener(view -> {
            startActivity(new Intent(getApplicationContext(), RenewalPay.class));
        });
        findViewById(R.id.btnReplace).setOnClickListener(view -> {
            startActivity(new Intent(getApplicationContext(), NewUpgrade.class));
        });
        findViewById(R.id.contri).setOnClickListener(view -> {
            requestQueue = Volley.newRequestQueue(getApplicationContext());
                    ...
                    response -> {
                        try {
                            ...
                            if (success == 1) {
                                ...
                                sessionAda = new SessionAda(TreHome.this, R.layout.ndugu, checkModeArrayList1);
                    ...
                    respon -> {
                        try {
                            ...
                            if (succe == 1) {
                                ...
                                if (issuedMode.getExpiry().equals("Active")) {
                                    startActivity(new Intent(getApplicationContext(), ManageContri.class));
                                } else {
                                    AlertDialog.Builder factor = new AlertDialog.Builder(this);
                                    factor.setTitle(Html.fromHtml("<font color='#950365'><b><u>Expired Card</u></b></font>"));
                                    rect = new Rect();
                                            ...
                                            respo -> {
                                                try {
                                                    ...
                                                    if (success == 1) {
                                                        ...
                                                        termedMem.setText(Html.fromHtml("<font color='#000000'><big><b><strong>CARDS</strong></b></big><br><b><strong>freshCards</strong></b>&nbsp;&nbsp;:Kes" + moneyMoney.getFresh() + "<br>&nbsp;&nbsp;&nbsp;<b><strong>renewals</strong></b>&nbsp;&nbsp;:Kes" + moneyMoney.getRenewal() + "<br>&nbsp;&nbsp;&nbsp;<b><strong>upgrades</strong></b>&nbsp;&nbsp;:Kes" + moneyMoney.getUpgrade() + "<br><br><big><b><strong>CONTRIBUTION</strong></b></big><br><b><strong>eventPAY</strong></b>&nbsp;&nbsp;:Kes" + moneyMoney.getEvent_pay() + "<br><b><strong>contribution</strong></b>&nbsp;&nbsp;:Kes<u>" + moneyMoney.getContribute() + "</u><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><strong>total</strong></b>&nbsp;&nbsp;:Kes<u>" + moneyMoney.getWhole() + "</u><br><br><b><big><strong>WITHDRAWALS</strong></big></b><br><u><b><strong>eventExpenditure</strong></b>&nbsp;&nbsp;:Kes" + moneyMoney.getWithdraw() + "</u><br><b><big><strong>CURRENT BALANCE</strong></big></b>&nbsp;&nbsp;:Kes<b><big><u>" + moneyMoney.getBal() + "</u></big></b></font>"));
                                                        majorGenrali.setText(Html.fromHtml("<font color='#000000'><u><strong><big><b>ACCOUNT RECORD</b></big><br>as at " + moneyMoney.getLast() + "</strong></u></font>"));
