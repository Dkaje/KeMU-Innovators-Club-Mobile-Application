...
public class KihindoAda extends ArrayAdapter<Kihingo> {
    public ArrayList<Kihingo> MainList;
    public ArrayList<Kihingo> SubjectListTemp;
    public SubjectDataFilter subjectDataFilter;

    public KihindoAda(Context context, int id, ArrayList<Kihingo> subjectArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Kihingo subject = SubjectListTemp.get(position);
        int pos = position + 1;
    ...
    private class SubjectDataFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            if (charSequence != null && charSequence.toString().length() > 0) {
                ArrayList<Kihingo> arrayList1 = new ArrayList<>();

                for (int i = 0, l = MainList.size(); i < l; i++) {
                    Kihingo subject = MainList.get(i);
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
            ...
            SubjectListTemp = (ArrayList<Kihingo>) filterResults.values;
