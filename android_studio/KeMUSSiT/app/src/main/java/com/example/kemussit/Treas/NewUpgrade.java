...
public class NewUpgrade extends AppCompatActivity {
    PayAda cardAda;
    PayMode cardMode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("New Upgrades");
        ...
        listView.setOnItemClickListener((adapterView, view, i, l) -> {
            ...
            alertDialog.getButton(DialogInterface.BUTTON_POSITIVE).setOnClickListener(view1 -> {
                ...
                requestQueue.add(new StringRequest(Request.Method.POST, Connect.intelUp,
                        response -> {
                            try {
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        params.put("status", "1");
                        params.put("finsta", "1");
                        params.put("upgrade", cardMode.getFees());
                        params.put("reg_date", new SimpleDateFormat("yyyy-MM-dd hh:mm a").format(new Date()));
                        params.put("alrt", "Your card payment was approved.");
            ...
            alertDialog.getButton(DialogInterface.BUTTON_NEGATIVE).setOnClickListener(view1 -> {
                ...
                requestQueue.add(new StringRequest(Request.Method.POST, Connect.intelUp,
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        params.put("status", "2");
                        params.put("finsta", "2");
                        params.put("upgrade", "0");
                        params.put("reg_date", new SimpleDateFormat("yyyy-MM-dd hh:mm a").format(new Date()));
                        params.put("alrt", "Your card payment was rejected.");
                        params.put("user", cardMode.getReg_no());
                        return params;
                    }
                });
                ...
                response -> {
                    try {
                        ...
                        if (success == 1) {
                            ...
                            cardAda = new PayAda(NewUpgrade.this, R.layout.roller, cardModeArrayList);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.App:
                startActivity(new Intent(getApplicationContext(), AppUpgrade.class));
                break;
            case R.id.Rej:
                startActivity(new Intent(getApplicationContext(), RejUp.class));
                break;
            default:
        }
