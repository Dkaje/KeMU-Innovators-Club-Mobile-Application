...
public class SecHome extends AppCompatActivity {
    Model model;
    SecSess stuSess;
    ...
    private void getMajors() {
        ...
        helper.setOnClickListener(view -> {
            ...
            help.setTitle("Help Secretary General");
            help.setMessage(getString(R.string.Sec));
        ...
        findViewById(R.id.btnCardy).setOnClickListener(view -> {
            startActivity(new Intent(getApplicationContext(), Smarta.class));
        });
        findViewById(R.id.btnIssue).setOnClickListener(view -> {
                    ...
                    response -> {
                        try {
                            ...
                            if (success == 1) {
                                ...
                                sessionAda = new SessionAda(SecHome.this, R.layout.ndugu, checkModeArrayList1);
        ...
        findViewById(R.id.btnRenew).setOnClickListener(view -> {
            requestQueue = Volley.newRequestQueue(getApplicationContext());
                    ...
                    respon -> {
                        try {
                            ...
                            if (succe == 1) {
                                ...
                                if (issuedMode.getExpiry().equals("Active")) {
                                    startActivity(new Intent(getApplicationContext(), ManageAnn.class).putExtra("term", mTerm).putExtra("ses", mId));
                                } else {
                                    AlertDialog.Builder factor = new AlertDialog.Builder(this);
                                    factor.setTitle(Html.fromHtml("<font color='#950365'><b><u>Expired Card</u></b></font>"));
                                    rect = new Rect();
