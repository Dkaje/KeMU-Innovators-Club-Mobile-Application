...
public class ManageContri extends AppCompatActivity {
    LastAda cardAda;
    LastDay cardMode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("New EventPay");
        setContentView(R.layout.activity_manage_contri);
        ...
        listView.setOnItemClickListener((adapterView, view, i, l) -> {
            ...
            alertDialog.getButton(DialogInterface.BUTTON_POSITIVE).setOnClickListener(view1 -> {
                ...
                requestQueue.add(new StringRequest(Request.Method.POST, Connect.appCon,
                        response -> {
                            try {
            ...
            alertDialog.getButton(DialogInterface.BUTTON_NEGATIVE).setOnClickListener(view1 -> {
                ...
                requestQueue.add(new StringRequest(Request.Method.POST, Connect.appCon,
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        params.put("fresh", "0");
                        params.put("reg_date", new SimpleDateFormat("yyyy-MM-dd hh:mm a").format(new Date()));
                        params.put("alrt", "Your Event payment was rejected.");
                        params.put("user", cardMode.getReg_no());
                        return params;
                    }
                });
    ...
    private void getCard() {
        requestQueue = Volley.newRequestQueue(getApplicationContext());
        requestQueue.add(new StringRequest(Request.Method.POST, Connect.getCont,
                response -> {
                    try {
                        jsonObject = new JSONObject(response);
                        ...
                        if (success == 1) {
                            ...
                            cardAda = new LastAda(ManageContri.this, R.layout.roller, cardModeArrayList);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.App:
                startActivity(new Intent(getApplicationContext(), ConApp.class));
                break;
            case R.id.Rej:
                startActivity(new Intent(getApplicationContext(), ConRej.class));
                break;
            default:
        }
