...
public class TakeOver extends ArrayAdapter<ViewRegistry> {
    ...
    public TakeOver(Context context, int id, ArrayList<ViewRegistry> subjectArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.txtamt.setText(subject.getPat());
        return convertView;
    }
